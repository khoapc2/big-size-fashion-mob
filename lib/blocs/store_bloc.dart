...
class StoreBloc {
  Future<StoreResponseModel> getAllStore() async {
    ...
    if (response.statusCode == 200) {
      storeResponseModel =
          StoreResponseModel.fromJson(json.decode(response.body));
    } else {
  ...
  Future<GetNearestStoreModel> getNearestStore(
    ...
    if (response.statusCode == 200) {
      storeResponseModel =
          GetNearestStoreModel.fromJson(json.decode(response.body));
    } else {
      throw Exception(Exception);
    }
    return storeResponseModel;
