...
class _StateBody extends State<Body> {
  ...
  Future<GetNearestStoreModel> getNearestStores(
                    ...
                    return SingleChildScrollView(
                        child: Padding(
                            ...
                            child: Column(
                                ...
                                children:
                                    listAddress(snapshot.data!, token.data!)
                                // [
    ...
    return List.generate(
        ...
        (index) => GestureDetector(
            onTap: () async {
              ...
              locationSelected
                  .setLocation(data.content![index].receiveAddress!);
              ...
              currentListCart.setShippingFee(30000);
              currentListCart.setStoreId(2);
              print("Tiền phí vận chuyển là:" +
                  currentListCart.shippingFee.toString());
                        ...
                        Row(
                          ...
                          children: [
                            ...
                            Container(
                              ...
                              child: Text(
                                data.content![index].receiverName!,
                                style: TextStyle(
                        ...
                        Row(
                          ...
                          children: [
                            ...
                            Container(
                              margin: EdgeInsets.only(left: 10),
                              child: Text(
                                data.content![index].receiverPhone!,
                                style: TextStyle(
                                    color: Colors.black, fontSize: 18),
                              ),
                            )
                        ...
                        Row(
                          ...
                          children: [
                            ...
                            Container(
                                width: 230.0,
                                child: Text(
                                  data.content![index].receiveAddress!,
                                  style: TextStyle(
                                      color: Colors.black, fontSize: 18),
                                )),
                          ],
